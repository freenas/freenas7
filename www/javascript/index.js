/*
	...
	All rights reserved.
*/
function update_controls(value) {
...
function update_callback() {
	var client = new xmlrpc_client("xmlrpc.php?encoding=json", location.hostname, "80");
	var msg = new xmlrpcmsg("System.GetInfo", null);
	var response = client.send(msg);
	var data = eval('(' + xmlrpc_decode(response.value()) + ')');
